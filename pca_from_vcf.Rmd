...
```{r}
snps <- vcfR::read.vcfR("C:/Users/slind/OneDrive/Desktop/Strickland Lab/honors thesis code/guttata300_r0.5.snps.vcf", convertNA  = TRUE)
```
...
ggpubr::ggscatter(data = pca_scores2,
                  ...
                  x = "PC1",
                  color = "pop_id",
                  xlab = "PC1 (15.9% variation)",
                  ylab = "PC2 (7.3% variation)",
                  main = "D. guttata Variation") + xlim(-3, 3) + ylim(-3, 3)
```